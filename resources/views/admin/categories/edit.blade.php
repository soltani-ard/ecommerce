...
@section('content')
    <div class="container-xl px-4">
        <div class="card card-header-actions mb-4">
            <div class="card-header">ویرایش دسته بندی‌ - {{$category->name}}
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select class="form-select" id="parent_id" name="parent_id">
                                <option value="0" {{$category->parent_id == 0 ? 'selected' : ''}}>دسته اصلی</option>
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select class="form-select" id="is_active" name="is_active">
                                <option value="1" {{$category->getRawOriginal('is_active') == 1 ? 'selected' : ''}}>
                                    فعال
                                </option>
                                <option value="0" {{$category->getRawOriginal('is_active') == 0 ? 'selected' : ''}}>غیر
                                    فعال
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select id="attributeSelect" class="form-control" name="attribute_ids[]" multiple
                                ...
                                @foreach($attributes as $attribute)
                                    <option
                                        value="{{$attribute->id}}" {{in_array($attribute->id, $category->attributes->pluck('id')->toArray()) ? 'selected' : ''}}>{{$attribute->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5"
                                      placeholder="توضیحات (اختیاری)">{{$category->description}}</textarea>
                        </div>
                    </div>
                    <div class="">
